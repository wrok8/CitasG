...
export default function OARSScreen({
  ...
  return (
    <ScrollView style={{ padding: 16 }}>
      ...
      {/* 7 */}
      <Text style={styles.q}>
        7. ¿Cuántas veces habló por teléfono?
      </Text>
      {[
        "Ninguna",
        "Una vez a la semana",
      ...
      {/* 9 */}
      <Text style={styles.q}>
        9. ¿Tiene alguien en quien confiar?
      </Text>
      {["No", "Sí"].map((op) => (
        <Checkbox
          key={op}
      ...
      {[
        ...
        <Checkbox
          ...
          label={op}
          selected={
            form.frecuenciaFamilia === op
          }
          onPress={() =>
            setField("frecuenciaFamilia", op)
          }
        />
      ))}
